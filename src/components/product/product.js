    ...
    <div class="relative z-20 flex items-center overflow-hidden bg-white dark:bg-gray-800">
        <div class="container relative flex px-6 py-10 mx-auto">
            <div class="relative z-20 flex flex-col sm:w-3/5 md:w-3/5 lg:w-3/5">
                ...
                <div class="flex mt-8">
                    <a href="#" class="px-4 py-6 mr-4 text-white uppercase bg-pink-500 border-2 border-transparent rounded-lg text-md hover:bg-pink-400">
                        Comprar
                    </a>
                    <a href="#" class="px-4 py-4 text-pink-500 uppercase bg-transparent border-2 border-pink-500 rounded-lg dark:text-white hover:bg-pink-500 hover:text-white text-md">
                        Leer más
                    </a>
                </div>
            </div>
