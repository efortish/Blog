...
function PostDetail({
    ...
    return(
        <Layout>
            ...
            <h1 className="text-7xl font-bold tracking-tight text-black sm:text-5xl lg:text-6xl">{post.tittle}</h1>
            <div className="min-w-0 flex-1 p-4 pt-8">
                        <div className="">
                            ...
                            <span className="mt-2 mx-2 font-medium text-gray-800 text-sm">Lectura de {post.time_read} minutos</span> 
                            <p className="mt-4 text-xl  font-extrabold text-gray-800 leading-8">{post.excerpt}</p>
                        </div>
                    </div>
            </div>
        </div>
            ...
            <div className=" max-w-5xl  mx-auto mt-6 text-gray-500">
